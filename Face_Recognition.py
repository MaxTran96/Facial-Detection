...
#formatting  and loading face dataset
...
def separate_data(face_images, non_face_images):
    ...
    for i in range(len(face_images)-10):
        #simple shufflling using face, non-face, et...
